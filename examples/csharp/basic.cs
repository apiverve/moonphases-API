/*
 * Moon Phases API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Moon Phases API.
 * API Documentation: https://docs.apiverve.com/ref/moonphases
 */
    ...
    class MoonPhasesExample
    {
        ...
        static async Task<JsonDocument> CallMoonPhasesAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;date&quot;] &#x3D; &quot;12-02-2025&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Moon Phases API...\n");

            var result = await CallMoonPhasesAPI();
