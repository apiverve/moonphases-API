# Moon Phases API - Examples

This folder contains example code for using the Moon Phases API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/moonphases',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/moonphases");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/moonphases](https://docs.apiverve.com/ref/moonphases)
